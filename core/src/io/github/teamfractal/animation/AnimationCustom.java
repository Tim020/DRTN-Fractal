 ...
 */
public class AnimationCustom implements IAnimation {
     ...
     * @param text           The text to be displayed during the animation.
     */
    public AnimationCustom(String text, BitmapFont font, int length) {
        this.text = text;
