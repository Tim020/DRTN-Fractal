...
public class LandPlotTest extends TesterFile {
    ...
    public void testInstallRobiticon() throws Exception {
        ...
        ResourceGroup productionModifiers;
        ...
        assertEquals(new ResourceGroup(0, 0, 1), productionModifiers);
        ...
        productionModifiers = plot.productionModifiers.clone();
        assertEquals(new ResourceGroup(0, 1, 1), productionModifiers);
        ...
        productionModifiers = plot.productionModifiers.clone();
        assertEquals(new ResourceGroup(0, 1, 2), productionModifiers);
        ...
        productionModifiers = plot.productionModifiers.clone();
        assertEquals(new ResourceGroup(1, 1, 2), productionModifiers);
    }
    ...
    public void testProduceResources() throws Exception {
		...
		assertEquals(new ResourceGroup(0,0,3), plot.produceResources());
		Roboticon roboticon2 = new Roboticon(0);
		roboticon2.setCustomisation(ResourceType.ORE);
		plot.installRoboticon(roboticon2);
        assertEquals(new ResourceGroup(0,0,6), plot.produceResources());
    }
